...
const OnboardingPage = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gray-900 text-white flex flex-col justify-center py-12 sm:px-6 lg:px-8 mt-10">
          ...
          <div className="bg-gray-800 py-8 px-4 shadow-lg sm:rounded-lg sm:px-10">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                ...
                <div className="sm:col-span-6">
                  <label htmlFor="commitment" className_="block text-sm font-medium text-gray-300">
