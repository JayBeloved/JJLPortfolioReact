      ...
      <section id="student-hero" className="relative h-screen flex items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 p-4">
          <h1 className="text-5xl md:text-7xl font-bold mb-4 bg-gradient-to-r from-purple-400 to-blue-600 bg-clip-text text-transparent">
            Unlock Comet for Students – Free & Premium AI Tools Designed for Your Academic Success!
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto mb-8">
            Are you a student at a university, polytechnic, or higher institution? Get exclusive access to powerful AI tools and premium research features—just by signing up with your school email (...@schoolname.edu.ng).
          </p>
          <a href={studentProLink} target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white px-8 py-4 rounded-lg font-bold text-xl hover:bg-blue-700 transition-colors">
            Sign up with your .edu.ng email – unlock all features and boost your academic performance!
          </a>
        </div>
      </section>
